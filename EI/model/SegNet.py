...
class SegNet(nn.Module):
    def __init__(self, in_ch=3, out_ch=1):  # 修改接口参数[2](@ref)
        super(SegNet, self).__init__()
        batchNorm_momentum = 0.1

        self.conv11 = nn.Conv2d(in_ch, 64, kernel_size=3, padding=1)  # 3->in_ch
        ...
        self.conv11d = nn.Conv2d(64, out_ch, kernel_size=1, padding=0)  # 3x3->1x1，19->out_ch
